...
def startroom_setup():
    ...
    for y in (0, screen_height - sprite_size):
        ...
        for x in range(0, screen_width, sprite_size):
            if (x != sprite_size * 3 and x != sprite_size * 4 and
               x != sprite_size * 10 and x != sprite_size * 11) or y == 0:
...
def outside3_setup():
    ...
    for y in (0, screen_height - sprite_size):
        for x in range(0, screen_width, sprite_size):
            if (y == 0 and (x != sprite_size * 10 and
               x != sprite_size * 11)) or (y != 0 and (x != sprite_size * 5 and
                                                       x != sprite_size * 6)):
                wall = arcade.Sprite("images/boxCrate_double.png",
                                     sprite_scale)
                wall.left = x
...
def outside4_setup():
    ...
    for y in (0, screen_height - sprite_size):
        for x in range(0, screen_width, sprite_size):
            if (y == 0 and (x != sprite_size * 15 and
               x != sprite_size * 16)) or (y != 0 and (x != sprite_size * 5 and
                                                       x != sprite_size * 6)):
                wall = arcade.Sprite("images/boxCrate_double.png",
                                     sprite_scale)
                wall.left = x
...
def outside5_setup():
    ...
    for y in (0, screen_height - sprite_size):
        for x in range(0, screen_width, sprite_size):
            if y == 0 or (x != sprite_size * 5 and x != sprite_size * 6 and
                          x != sprite_size * 15 and x != sprite_size * 16):
                wall = arcade.Sprite("images/boxCrate_double.png",
                                     sprite_scale)
                wall.left = x
                wall.bottom = y
...
def river1_setup():
    ...
    for y in (0, screen_height - sprite_size):
        for x in range(0, screen_width, sprite_size):
            if y == 0 or (x != sprite_size * 2 and x != sprite_size * 3 and
                          x != sprite_size * 5 and x != sprite_size * 6):
                wall = arcade.Sprite("images/boxCrate_double.png",
                                     sprite_scale)
                wall.left = x
                wall.bottom = y
