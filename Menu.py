...
def help_menu():
    arcade.draw_text("How to play", screen_width/2, 600, arcade.color.BLACK, 50,
                            align="center", anchor_x="center", anchor_y="center")
    arcade.draw_text("Control", 300, 500, arcade.color.BLACK, 45)
    arcade.draw_text("W: Move Upward \nA: Move Left \nS: Move Downward \nD: Move Right \n\nJ: Melee Attack \nK: Range Attack", 300, 280, arcade.color.BLACK, 30)
